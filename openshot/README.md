...
This example shows how to stream an instance of OpenShot, on Selkies using the GKE WebRTC VDI stack.

## Dependencies

- App Launcher: [v1.0.0+](https://github.com/selkies-project/selkies/tree/master)
- WebRTC Streaming Stack: [v1.4.0+](https://github.com/selkies-project/selkies/tree/master)

## Features

- OpenShot single application streaming experience.
- Software renderer when Node Tier is `standard`.
- Default app type is `deployment` with minimum 2 pod replicas always available.
- Uses [Ubuntu Focal App Streaming](https://github.com/selkies-project/selkies-vdi/blob/master/images/app-streaming/Dockerfile.focal) base image.
